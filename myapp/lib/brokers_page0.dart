...
class _BrokersPageState extends State<BrokersPage> {
  ...
  //     children: <Widget>[Expanded(child: buildBrokers())],
    ...
    if (brokers.isEmpty) {
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          //buildUser(user.key, user.value);
        },
      );
    }
  }

  // return _brokers.entries
  //     .map((e) => _urlButton(context, e.key, e.value))
  //     .toList();
  ...
  //         return buildBroker(broker.);
  //       },
  //     );
  //   }
  // }

  // Widget buildBroker(User user) {
